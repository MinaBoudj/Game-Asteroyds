...
public class BlueAsteroyd extends Asteroyd{
    ...
    public void move(Cell[][] gameBoard, int[] directions) { // Mouvements d'un astéroïde bleu : 1 pas + peut pousser si besoin
      ...
      try{
          ...
          if(gameBoard[pos1.getX()][pos1.getY()]!= null && gameBoard[pos1.getX()][pos1.getY()] instanceof EmptyCell && gameBoard[pos.getX()][pos.getY()].LSpaceShips == 0){ // Si la première case est vide
